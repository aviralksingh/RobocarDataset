...
from sdk.robocar_dataset_sdk.python.interpolate_poses import interpolate_vo_poses, interpolate_ins_poses
from sdk.robocar_dataset_sdk.python.velodyne import load_velodyne_raw, load_velodyne_binary, velodyne_raw_to_pointcloud
...
if __name__ == '__main__':
    ...
    parser.add_argument('--poses_file', type=str, default="/media/aviral/Barracuda_1/Robocar/RobocarDataset/2014-05-06-12-54-54/vo/vo.csv", help='File containing relative or absolute poses')
    parser.add_argument('--extrinsics_dir', type=str, default="../../../sdk/robocar_dataset_sdk/extrinsics/",
                        help='Directory containing extrinsic calibrations')
    parser.add_argument('--laser_dir', type=str, default="/media/aviral/Barracuda_1/Robocar/RobocarDataset/2014-05-06-12-54-54/ldmrs/", help='Directory containing LIDAR data')
